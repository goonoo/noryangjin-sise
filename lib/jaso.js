...
var exports = module.exports = function (text) {
  ...
  for (i = 0; i < text.length; i++) {
    ...
    if (chars[i] >= 0xAC00 && chars[i] <= 0xD7A3) {
      ...
      i2 = i3 / 28;
      i3 = i3 % 28;
      v.push(String.fromCharCode(ChoSeong[parseInt(i1, 16)]));
      v.push(String.fromCharCode(JungSeong[parseInt(i2, 16)]));
      if (i3 !== 0x0000) {
        v.push(String.fromCharCode(JongSeong[parseInt(i3, 16)]));
      }
    } else {
